...
export const inputAlert = ({ title, text, placeholder, showConfirmButton, confirmButton, showDenyButton, denyButton, showCancelButton, cancelButton }) => {
  const params = {
    title: title || 'Hej!',
    text: text,
    type: 'input',
    inputPlaceholder: placeholder || 'Write here...',
    showConfirmButton: showConfirmButton || true,
    confirmButtonText: confirmButton || 'Okay',
    showDenyButton: showDenyButton || false,
    denyButtonText: denyButton || 'No',
