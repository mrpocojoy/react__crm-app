...
import Icon from 'components/template/icon/Icon'
import CustomAnchor from 'components/template/custom-anchor/CustomAnchor'
  ...
  return (
    <>
      <div className='search-bar__mobile-toggle'>
        <CustomAnchor action={toggleSearchBar} classes="mobile-only">
          Filter Devices
        </CustomAnchor>
      </div>
